 ...
 */
class Invoice extends \VRpay\Models\Base
{
     ...
     * can be found here: http://developers.vr-pay-secure.de/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the VRpay site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.vr-pay-secure.de/docs/miscellaneous
     *
    ...
    {
        return new \VRpay\Models\Response\Invoice();
    }
}
